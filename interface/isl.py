...
class union_map:
    ...
    def intersect_range(self, arg1):
        ...
        return union_map(ctx=self.ctx, ptr=res)
    def subtract_domain(self, arg1):
        try:
            if not arg1.__class__ is union_set:
                arg1 = union_set(arg1)
        except:
            raise
        res = isl.isl_union_map_subtract_domain(isl.isl_union_map_copy(self.ptr), isl.isl_union_set_copy(arg1.ptr))
        return union_map(ctx=self.ctx, ptr=res)
    def subtract_range(self, arg1):
        try:
            if not arg1.__class__ is union_set:
                arg1 = union_set(arg1)
        except:
            raise
        res = isl.isl_union_map_subtract_range(isl.isl_union_map_copy(self.ptr), isl.isl_union_set_copy(arg1.ptr))
        return union_map(ctx=self.ctx, ptr=res)
    ...
    def detect_equalities(self):
        res = isl.isl_union_map_detect_equalities(isl.isl_union_map_copy(self.ptr))
        return union_map(ctx=self.ctx, ptr=res)
    def deltas(self):
...
class map(union_map):
    ...
    def is_equal(self, arg1):
        ...
        return res
    def is_disjoint(self, arg1):
        try:
            if not arg1.__class__ is map:
                arg1 = map(arg1)
        except:
            return union_map(self).is_disjoint(arg1)
        res = isl.isl_map_is_disjoint(self.ptr, arg1.ptr)
        return res
    def is_single_valued(self):
...
class set(union_set):
    ...
    def is_disjoint(self, arg1):
        try:
            ...
            return union_set(self).is_disjoint(arg1)
        res = isl.isl_set_is_disjoint(self.ptr, arg1.ptr)
        return res
    def gist(self, arg1):
        try:
            if not arg1.__class__ is set:
